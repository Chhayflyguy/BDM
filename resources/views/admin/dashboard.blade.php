                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <a href="{{ route('admin.products.index') }}" class="group flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 hover:shadow-md transition-all duration-200">
                            ...
                            <a href="{{ route('admin.services.index') }}" class="group flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:shadow-md transition-all duration-200">
                            ...
                            <a href="{{ route('admin.bookings.index') }}" class="group flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:border-green-300 hover:shadow-md transition-all duration-200">
                            ...
                            <a href="{{ route('admin.products.create') }}" class="group flex items-center p-4 bg-white border border-gray-200 rounded-lg hover:border-indigo-300 hover:shadow-md transition-all duration-200">
